...
import { store as storeMonitor } from '@/actions/App/Http/Controllers/MonitorController';
...
const submit = () => {
    ...
    })).post(storeMonitor.url(props.project.id));
};
</script>

<template>
    <AppLayout>
        <Head :title="`Add Monitor - ${project.name}`" />
        ...
        <div class="mx-auto max-w-2xl space-y-6">
            <div>
                ...
                <h1 class="text-2xl font-bold tracking-tight">Add Monitor</h1>
                <p class="text-base-content/60 mt-1 text-xs">
                    Configure an endpoint health check for this project
                </p>
            </div>
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            class="input input-bordered bg-base-200/50 w-full text-sm"
                            :class="{
                                'input-error': !!form.errors.timeout_seconds,
                            }"
                        />
